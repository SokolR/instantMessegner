...
public class UserFrame implements UserView {
    ...
    public void createGUI(){
        ...
        viewAll.setContentPane(new JPanel());
    ...
    public void setMenuListener(){
        menu.getPrivate().addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                final SimpleFrame titleChat = new SimpleFrame("Private", new JLabel("Enter title chat please"), new JButton("NEXT"));
                titleChat.setBackground(Color.DARK_GRAY);
