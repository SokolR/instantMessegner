...
public class ClientController extends Thread implements ControllerActionsClient {
    ...
    public void registration(String login, String password) {
        if (login != null && !login.trim().equals("") && password != null) {
            ...
            aut.setList(logPas);
            aut.setKeyDialog(11);
            sendMessage(aut, Properties.Registration.name());
        }
    }
    ...
    public void authentication(String login, String password) {
        if (login != null && !login.trim().equals("") && password != null) {
            ...
            aut.setList(logPas);
            aut.setKeyDialog(11);
            sendMessage(aut, Properties.Authentication.name());
        }
    }
    ...
    public void remove() {
        ...
        int n = JOptionPane
                .showOptionDialog(null, SURE,
                        ...
                        options[0]);
        if (n == 0) {
            sendMessage(userXml, Properties.Remove.name());
        }
    }
    ...
    public void ban(String banUser) {
        ...
        sendMessage(userSet, Properties.Ban.name());
    }
    ...
    public void remove(String removeUser) {
        ...
        userSet.setList(login);
        sendMessage(userSet, Properties.Remove.name());
    }
    ...
    public void unBan(String unBanUser) {
        ...
        login.add(unBanUser);
        userSet.setList(login);
        sendMessage(userSet, Properties.UnBan.name());
    }
    ...
    public void sendPrivateMessage(List<String> users, String msg, int keyDialog) {
       ...
       List<String> exitUser = new ArrayList<>();
        ...
        if(exitUser.size()==0) {
            ...
            sendMessage(userSet, Properties.PrivateMessage.name());
        } else {
    ...
    public void sendAllMessage(String msg) {
        ...
        msg = msg.replaceAll("\\n", "<br>");
        userSet.setMessage(myUser + ": <br>" + msg);
        sendMessage(userSet, Properties.MessageForAll.name());
    ...
    public void editUser(String newPassword) {
        ...
        sendMessage(userSet, Properties.Edit.name());
    }
    ...
    public void run() {
        while (true) {
            ...
            if (buff != null) {
                if (!authentication) {
                    if (buff.getProperty().equals(Properties.Registration.name()) &&
                            buff.getMessage().equals(Properties.Successfully.name())) {
                        userSet = getUserXml();
                        for (ChatView cv : views) {
                            cv.closeEnterToChat();
                            cv.createUserView();
                    ...
                    if (buff.getProperty().equals(Properties.Authentication.name()) && buff.getMessage().equals(Properties.Successfully.name())) {
                        userSet = getUserXml();
                        for (ChatView cv : views) {
                            cv.closeEnterToChat();
                            cv.createUserView();
                    ...
                    if (buff.getProperty().equals(Properties.Authentication.name()) && buff.getMessage().equals(Properties.Ban.name())) {
                    ...
                    if (buff.getProperty().equals(Properties.Admin.name())) {
                        admin = true;
                        userSet = getUserXml();
                        sendMessage(getUserXml(), Properties.BanUsers.name());
                        authentication = true;
                    }

                    if (buff.getProperty().equals(Properties.Authentication.name()) && buff.getMessage().equals(ONLINE_USER)) {
                        JOptionPane.showMessageDialog(null, ONLINE_USER);

                    }
                    if (buff.getProperty().equals(Properties.Authentication.name()) && buff.getMessage().equals(EXIST_USER)) {
                        JOptionPane.showMessageDialog(null, EXIST_USER);
                    }
                    if (buff.getProperty().equals(Properties.Authentication.name()) && buff.getMessage().equals(WRONG_COMMAND)) {
                        JOptionPane.showMessageDialog(null, WRONG_COMMAND);
                    }
                }
                if (admin) {
                    if (getUserXml().getProperty().equals(Properties.BanUsers.name()) &&
                            getUserXml().getMessage().equals(Properties.BanUsers.name())) {
                    ...
                    if (buff.getProperty().equals(Properties.Remove.name()) && (buff.getMessage().equals(Properties.Admin.name()))) {
                        JOptionPane.showMessageDialog(null, REMOVE_ADMIN);
                    }
                    if (buff.getProperty().equals(Properties.Ban.name())) {
                    ...
                    if (buff.getProperty().equals(Properties.UnBan.name())) {
                ...
                if (buff.getProperty().equals(Properties.MessageForAll.name())) {
                    try {
                        if (ban) continue;
                ...
                if (buff.getProperty().equals(Properties.ActiveUsers.name())) {
                ...
                if (buff.getProperty().equals(Properties.PrivateMessage.name())) {
                    if (ban) continue;
                    String msg = buff.getMessage().replaceAll("<br>", "\n");
                ...
                if (buff.getProperty().equals(Properties.Edit.name()) && buff.getMessage().equals(Properties.Successfully.name())) {
                ...
                if (buff.getProperty().equals(Properties.Edit.name()) && buff.getMessage().equals(Properties.IncorrectValue.name())) {
                    JOptionPane.showMessageDialog(null, Properties.IncorrectValue.name());
                }

                if (buff.getProperty().equals(Properties.Remove.name()) && (buff.getMessage().equals(Properties.Successfully.name()))) {
                    JOptionPane.showMessageDialog(null, REMOVE);
                    closeChat();
                    System.exit(3);
                }
                if (buff.getProperty().equals(Properties.Remove.name()) && (buff.getMessage().equals(DELETE))) {
                    JOptionPane.showMessageDialog(null, DELETE);
                    closeChat();
                    System.exit(4);
                }

                if (buff.getProperty().equals(Properties.Ban.name()) && (buff.getMessage().equals(Properties.Ban.name()))) {
                    ban = true;
                    JOptionPane.showMessageDialog(null, BAN);
                }
                if (buff.getProperty().equals(Properties.UnBan.name()) && (buff.getMessage().equals(UNBAN))) {
                    ban = false;
                    JOptionPane.showMessageDialog(null, UNBAN);
                }
                if(buff.getProperty().equals(Properties.Stop.name())){
                    closeSocket();
                    JOptionPane.showMessageDialog(null, "Server is down. Try to reconnect");
